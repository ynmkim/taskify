...
const AddColumnButton = () => {
  ...
  return(
    <>
      <button className="ml-[9px] mr-[15px] my-3 md:mx-5 md:my-5 lg:mt-[68px] px-[60px] py-5 md:px-[180px] lg:px-[86px] md:py-6 bg-white rounded-md border border-gray-D9D9D9 h-fit">
