          ...
          <div className="flex flex-col gap-4 order-2 md:order-1">
            <div className="flex gap-5">
              ...
              <div className="flex gap-1.5">
                <Chip variant="basic" color="orange" size="large">
                  프로젝트
                </Chip>
                <Chip variant="basic" color="green" size="large">
                  일반
                </Chip>
                <Chip variant="basic" color="pink" size="large">
                  백엔드
                </Chip>
                <Chip variant="basic" color="blue" size="large">
                  상
                </Chip>
              </div>
            </div>
            <p className="font-Pretendard text-xs">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, nemo numquam quaerat ex quae ipsum
              praesentium voluptatem rem sed quibusdam quo accusamus nobis, vel inventore! Inventore nemo fuga vitae
              qui?
            </p>
